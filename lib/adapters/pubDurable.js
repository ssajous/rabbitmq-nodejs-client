...
PubDurableAdapter.prototype._init = function(callback) {
...
PubDurableAdapter.prototype._openCallback = function(exchange) {

    this.hub.on('message', function(msg, routingKey) {
      console.log("[" + new Date() + "]: " + " Publishing Message - " + msg);
